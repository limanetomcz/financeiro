...
class ContratoController extends Controller
{
    ...
    public function store(Request $request, CriarContratoService $service): JsonResponse
    {
        $dados = $request->validate([
            ...
            'contratante.endereco' => ['nullable', 'string', 'max:255'],
            'contratante.bairro' => ['nullable', 'string', 'max:80'],
            'contratante.cidade' => ['nullable', 'string', 'max:80'],
            'contratante.cep' => ['nullable', 'string', 'max:10'],
            'contratante.uf' => ['nullable', 'string', 'max:2'],
            'contratante.empresa_id' => ['nullable', 'uuid', 'exists:contratantes,id'],
